...
<body>
    <section class="section_cart">
        <header>
            ...
            <nav>
                ...
                <a href="#" class="active" ><b>Add Prod</b></a>
    ...
    <section class="sec_background">
        ...
        <form action="upload_img.php" method="post" enctype="multipart/form-data">
     	...
     	<label>Pret in lei</label>
     	<input type="text" name="pret" placeholder="ex:35"><br>
        
        <label>Categorie</label>
     	<input type="text" name="categorie" placeholder="ex:Head"><br>

        <label>Numar de bucati</label>
     	<input type="text" name="stoc" placeholder="ex:12"><br>

        <label>Imagine</label><br>
        <br>
        <input type="file" class="add_file" name="image" /><br>

     	<button  class="butt_add" type="submit" name="upload">Add</button>
     </form>
